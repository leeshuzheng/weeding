export const FAQ = () => {
  return (
    <div className="flex flex-col gap-6 h-[440px] overflow-y-auto">
      <div className=" !list-disc !p-[1px]">
        <ul className="flex flex-col gap-3 !py-3">
          <li>
            <b className="!font-semibold">I don’t like weddings / parties</b>
            <br />
            Same tbh. So we’re keeping it open, come when you want, leave when you need. It’s meant to be enjoyable and
            non-anxiety inducing for you (and us)
          </li>
          <li>
          ...
          <li>
            ...
            <br />
            We’re keeping this intimate, so it’ll be invite-only and adults-only. Appreciate you helping us keep things
            cosy
          </li>
          <li>
          ...
          <li>
            ...
            <br />
            We’re not planning to have a frat rager, so keep it classy(ish) and please only vape discreetly and puke
          ...
          <li>
            ...
            <br />
            There’s a public carpark in Golden Mile Tower
          </li>
        </ul>
      </div>
    </div>
